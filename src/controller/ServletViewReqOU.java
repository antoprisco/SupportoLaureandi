		...
		try{
			...
			if(!list.isEmpty()) {
				...
				for(RequestOU rq:list) {
					...
					content+="<div class='b'><br><font size=4>Dati Anagrafici</font><br><br> data di nascita: <b>"+ rq.getDateOfBirth()+" </b><br>E-Mail: <b>"+ u.getEmail()+ "</b>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Telefono: <b>"+ rq.getCellNumber()+"</b><br>";
