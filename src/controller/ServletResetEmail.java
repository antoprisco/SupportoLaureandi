...
public class ServletResetEmail extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    System.out.println("questa � l'email passata alla servlet");
    System.out.println(email);
    System.out.println("questa � la password generata non criptata");
    System.out.println(newpass);
    System.out.println("questa � la password generata criptata");
    ...
    try {
      ...
      if (x == 1) {
        Mailer.send("sl.unisa2020@gmail.com", "supportolaureandi2020",
            ...
            "Ciao la tua nuova password � : " + newpass + "\n\n\n Il Team di Supporto Laureandi");
