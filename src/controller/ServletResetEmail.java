...
public class ServletResetEmail extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    System.out.println("questa è l'email passata alla servlet");
    System.out.println(email);
    System.out.println("questa è la password generata non criptata");
    System.out.println(newpass);
    System.out.println("questa è la password generata criptata");
    System.out.println(password);
    try {
    	int x = user.doSetPassword(email, password);
    	if (x == 1) {
    		Mailer.send("sl.unisa2020@gmail.com","supportolaureandi2020",email,"Reset Password Supporto Laureandi","Ciao la tua nuova password è : "+ newpass +"\n\n\n Il Team di Supporto Laureandi");    	
