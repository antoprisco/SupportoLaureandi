...
public class TitoloStudio {
  ...
  /**
   * Costruttore Titolo di Studio.
   */
  public TitoloStudio(
           String laurea, String dataL, String universita, int matricola, int voto, String lode) {
    this.laurea = laurea;
    this.dataL = dataL;
  ...
  public String toString() {
    return "TitoloStudio [laurea=" + laurea + ", universita=" + universita + ", lode=" 
         + lode + ", matricola=" + matricola + ", voto=" + voto + ", dataL=" + dataL + "]";
  }
