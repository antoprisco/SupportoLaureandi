...
import org.springframework.mock.web.MockHttpServletResponse;
  ...
  void test1() throws ServletException, IOException {
    UserInterface utente = 
        new Student("g.musacchio@studenti.unisa.it", "pasquale", "annarumma", 'M', "pippotto", 0);
    ...
    request.addParameter("dataL", "2014-05-03");request.addParameter("universita", "salerno");
    request.addParameter("matricola", "0512104133");
    request.addParameter("voto", "100");
    request.addParameter("scelta", "[{\\\"esame\\\":\\\"ALGORITMI AVANZATI\\\"},"
        + "{\\\"value\\\":\\\"1\\\"}]");
