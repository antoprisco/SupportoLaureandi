...
<body onLoad="showData()">
					...
					<div class="content-side col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="content ">
							<div class="news-block-seven">
								<table id="secretaryTable" class="display data-results table table-striped table-hover table-bordered">
									<thead>
										<tr>
	...
	<jsp:include page="/partials/includes.jsp" />
		...
		<script
		src="<%= request.getContextPath() %>/js/pages/scripts_viewReqOUSecretary.js">
		</script>
